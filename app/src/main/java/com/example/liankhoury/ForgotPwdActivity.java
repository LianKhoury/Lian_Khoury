...
public class ForgotPwdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextPwdResetEmail = findViewById(R.id.editText_pwd_reset_email);
        buttonPwdReset = findViewById(R.id.button_pwd_reset);
        ...
        buttonPwdReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email)) {
                    Toast.makeText(ForgotPwdActivity.this, "Please enter your registered email", Toast.LENGTH_SHORT).show();
        ...
        authProfile.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    // Clear stack to prevent user coming back to ForgotPwdActivity
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK );
                    startActivity(intent);
                    finish();       // close ForgotPwdActivity
                } else {
                    try {
